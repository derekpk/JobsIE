<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/JobsIE.Master" CodeBehind="CompUpdate.aspx.vb" Inherits="JobsIE.CompUpdate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Company Update</h2>
    <h2><asp:HyperLink ID="HyperLink_Finished" runat="server" EnableViewState="false">Finished Updating</asp:HyperLink></h2>
   ...
   <fieldset class="register">
        ...
        <p class="submitButton">
            <asp:Button ID="Button_UpdateCompany"
                runat="server"
                CausesValidation="True" 
                CommandName="Button_UpdateCompany"
                onclick="Button_UpdateCompany_Click"
